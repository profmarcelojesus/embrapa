...
# source("R/socialneworkanalysis.R")
```
...
```{r figciclows, fig.cap='Ciclo de Web Scraping', fig.align='center'}
...
ggplotly(plot_documentos_por_categoria) # |> layout(showlegend = FALSE)
```
